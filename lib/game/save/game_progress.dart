...
class GameProgress extends ChangeNotifier {
  ...
  static const List<CosmeticItem> cosmetics = [
    ...
    CosmeticItem(id: 'ball.plasma-purple', category: CosmeticCategory.ball, title: 'Plasma Purple', subtitle: 'Deep abstract energy', price: 300, color: Color(0xFF673AB7)),
    CosmeticItem(id: 'ball.cyber-pink', category: CosmeticCategory.ball, title: 'Cyber Pink', subtitle: 'Neon dystopia', price: 320, color: Color(0xFFFF007F)),
    CosmeticItem(id: 'ball.golden-ratio', category: CosmeticCategory.ball, title: 'Golden Ratio', subtitle: 'Perfect geometry', price: 350, color: Color(0xFFFFC107)),
    CosmeticItem(id: 'ball.toxic-bloom', category: CosmeticCategory.ball, title: 'Toxic Bloom', subtitle: 'Hazardous substance', price: 400, color: Color(0xFF00FF00)),
    CosmeticItem(id: 'ball.void-black', category: CosmeticCategory.ball, title: 'Void Black', subtitle: 'Light absorption', price: 420, color: Color(0xFF222222)),
    CosmeticItem(id: 'ball.supernova-white', category: CosmeticCategory.ball, title: 'Supernova White', subtitle: 'Blinding heat', price: 450, color: Color(0xFFFFFFFF)),
    CosmeticItem(id: 'ball.crimson-flare', category: CosmeticCategory.ball, title: 'Crimson Flare', subtitle: 'Plasma burst', price: 480, color: Color(0xFFFF0000)),
    CosmeticItem(id: 'ball.deep-ocean', category: CosmeticCategory.ball, title: 'Deep Ocean', subtitle: 'Abyssal depths', price: 500, color: Color(0xFF03A9F4)),
    CosmeticItem(id: 'ball.neon-orange', category: CosmeticCategory.ball, title: 'Neon Orange', subtitle: 'Warning sign', price: 550, color: Color(0xFFFF5722)),
    CosmeticItem(id: 'ball.glitch-blue', category: CosmeticCategory.ball, title: 'Glitch Blue', subtitle: 'Data corruption', price: 600, color: Color(0xFF3333FF)),
    CosmeticItem(id: 'ball.monochrome', category: CosmeticCategory.ball, title: 'Monochrome', subtitle: 'No color data', price: 650, color: Color(0xFF888888)),
    CosmeticItem(id: 'ball.radiant-violet', category: CosmeticCategory.ball, title: 'Radiant Violet', subtitle: 'High frequency', price: 700, color: Color(0xFF9C27B0)),

    CosmeticItem(id: 'trail.plasma-wake', category: CosmeticCategory.trail, title: 'Plasma Wake', subtitle: 'Deep trail energy', price: 300, color: Color(0xFF673AB7)),
    CosmeticItem(id: 'trail.pink-ribbon', category: CosmeticCategory.trail, title: 'Pink Ribbon', subtitle: 'Neon dystopia', price: 320, color: Color(0xFFFF007F)),
    CosmeticItem(id: 'trail.golden-path', category: CosmeticCategory.trail, title: 'Golden Path', subtitle: 'Perfect geometry', price: 350, color: Color(0xFFFFC107)),
    CosmeticItem(id: 'trail.toxic-spores', category: CosmeticCategory.trail, title: 'Toxic Spores', subtitle: 'Hazardous substance', price: 400, color: Color(0xFF00FF00)),
    CosmeticItem(id: 'trail.shadow-walk', category: CosmeticCategory.trail, title: 'Shadow Walk', subtitle: 'Light absorption', price: 420, color: Color(0xFF222222)),
    CosmeticItem(id: 'trail.light-beam', category: CosmeticCategory.trail, title: 'Light Beam', subtitle: 'Blinding heat', price: 450, color: Color(0xFFFFFFFF)),
    CosmeticItem(id: 'trail.crimson-spray', category: CosmeticCategory.trail, title: 'Crimson Spray', subtitle: 'Plasma burst', price: 480, color: Color(0xFFFF0000)),
    CosmeticItem(id: 'trail.ocean-foam', category: CosmeticCategory.trail, title: 'Ocean Foam', subtitle: 'Abyssal depths', price: 500, color: Color(0xFF03A9F4)),
    CosmeticItem(id: 'trail.fire-spark', category: CosmeticCategory.trail, title: 'Fire Spark', subtitle: 'Warning sign', price: 550, color: Color(0xFFFF5722)),
    CosmeticItem(id: 'trail.glitch-data', category: CosmeticCategory.trail, title: 'Glitch Data', subtitle: 'Data corruption', price: 600, color: Color(0xFF3333FF)),
    CosmeticItem(id: 'trail.ghost-trail', category: CosmeticCategory.trail, title: 'Ghost Trail', subtitle: 'No color data', price: 650, color: Color(0xFF888888)),
    CosmeticItem(id: 'trail.violet-dust', category: CosmeticCategory.trail, title: 'Violet Dust', subtitle: 'High frequency', price: 700, color: Color(0xFF9C27B0)),

    CosmeticItem(id: 'core.purple-singularity', category: CosmeticCategory.core, title: 'Purple Singularity', subtitle: 'Deep core energy', price: 300, color: Color(0xFF673AB7)),
    CosmeticItem(id: 'core.cyber-vortex', category: CosmeticCategory.core, title: 'Cyber Vortex', subtitle: 'Neon dystopia', price: 320, color: Color(0xFFFF007F)),
    CosmeticItem(id: 'core.golden-mass', category: CosmeticCategory.core, title: 'Golden Mass', subtitle: 'Perfect geometry', price: 350, color: Color(0xFFFFC107)),
    CosmeticItem(id: 'core.toxic-pulsar', category: CosmeticCategory.core, title: 'Toxic Pulsar', subtitle: 'Hazardous substance', price: 400, color: Color(0xFF00FF00)),
    CosmeticItem(id: 'core.dark-matter', category: CosmeticCategory.core, title: 'Dark Matter', subtitle: 'Light absorption', price: 420, color: Color(0xFF222222)),
    CosmeticItem(id: 'core.white-dwarf', category: CosmeticCategory.core, title: 'White Dwarf', subtitle: 'Blinding heat', price: 450, color: Color(0xFFFFFFFF)),
    CosmeticItem(id: 'core.crimson-nova', category: CosmeticCategory.core, title: 'Crimson Nova', subtitle: 'Plasma burst', price: 480, color: Color(0xFFFF0000)),
    CosmeticItem(id: 'core.ocean-pearl', category: CosmeticCategory.core, title: 'Ocean Pearl', subtitle: 'Abyssal depths', price: 500, color: Color(0xFF03A9F4)),
    CosmeticItem(id: 'core.solar-flare', category: CosmeticCategory.core, title: 'Solar Flare', subtitle: 'Warning sign', price: 550, color: Color(0xFFFF5722)),
    CosmeticItem(id: 'core.glitch-source', category: CosmeticCategory.core, title: 'Glitch Source', subtitle: 'Data corruption', price: 600, color: Color(0xFF3333FF)),
    CosmeticItem(id: 'core.iron-core', category: CosmeticCategory.core, title: 'Iron Core', subtitle: 'No color data', price: 650, color: Color(0xFF888888)),
    CosmeticItem(id: 'core.violet-gravity', category: CosmeticCategory.core, title: 'Violet Gravity', subtitle: 'High frequency', price: 700, color: Color(0xFF9C27B0)),
  ];
  ...
  bool _achievementConditionMet(String id) {
    ...
    return switch (id) {
      ...
      'cosmetic_all_balls' => unlockedCosmeticIds.containsAll(['ball.core-blue', 'ball.ion-green', 'ball.solar-warning', 'ball.plasma-purple', 'ball.cyber-pink', 'ball.golden-ratio', 'ball.toxic-bloom', 'ball.void-black', 'ball.supernova-white', 'ball.crimson-flare', 'ball.deep-ocean', 'ball.neon-orange', 'ball.glitch-blue', 'ball.monochrome', 'ball.radiant-violet']),
      'cosmetic_all_trails'=> unlockedCosmeticIds.containsAll(['trail.core-blue', 'trail.spark', 'trail.comet', 'trail.plasma-wake', 'trail.pink-ribbon', 'trail.golden-path', 'trail.toxic-spores', 'trail.shadow-walk', 'trail.light-beam', 'trail.crimson-spray', 'trail.ocean-foam', 'trail.fire-spark', 'trail.glitch-data', 'trail.ghost-trail', 'trail.violet-dust']),
      'cosmetic_all_cores' => unlockedCosmeticIds.containsAll(['core.core-blue', 'core.ion-green', 'core.red-shift', 'core.purple-singularity', 'core.cyber-vortex', 'core.golden-mass', 'core.toxic-pulsar', 'core.dark-matter', 'core.white-dwarf', 'core.crimson-nova', 'core.ocean-pearl', 'core.solar-flare', 'core.glitch-source', 'core.iron-core', 'core.violet-gravity']),
      'cosmetic_all'       => unlockedCosmeticIds.length >= 45,
